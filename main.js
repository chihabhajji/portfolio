...
window.onload = function(){
  ...
  // BACKGROUND
  new THREE.TextureLoader().load('space.jpg', (texture)=>{
    scene.background = texture
  });

  // AVATAR
  const chihabCubeTexture = new THREE.TextureLoader().load('avatar.jfif',(texture)=>{
  ...
  // MOON
  const moonTexture = new THREE.TextureLoader().load('moon.jpg',(mt)=>{});
  const normaMapMoon = new THREE.TextureLoader().load('normal.jpg', (nmm)=>{})
